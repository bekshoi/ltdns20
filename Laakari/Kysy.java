...
Ohjelmassa tulostetaan valikko ja testataan mink� valinnan k�ytt�j� sy�tti
Opittava asia: switch - case (default)
@author Marko Hassinen
@version 1.1
*/

// Otetaan k�ytt��n java.util pakkaus
...
public class Kysy
{
   ...
   public static int kluku()
   {
      ...
      do
      {
         try
         {
            String sLuku = lukija.nextLine(); // Luetaan k�ytt�j�n valinta
   ...
   public static char merkki()
   {
      ...
      do
      {
         try
         {
            String sSyote= lukija.nextLine(); // Luetaan k�ytt�j�n valinta
            cMerkki = sSyote.charAt(0);
            bHyvaSyote=true;
         }
         catch(Exception e)
         {
            System.out.println("Huono sy�te! Anna merkki");
            bHyvaSyote = false;
         }
      }while(!bHyvaSyote);
      return cMerkki;
    ...
    public static boolean totuusarvo()
    {
      ...
      do
      {
         ...
         {
            System.out.println("Huono sy�te! Sy�t� k tai e");
            bHyvaSyote = false;
         }
   	  }while(!bHyvaSyote);
   	  if(cMerkki == 'k')
